...
{
    public class ProfitLossReportCompanyCustomPdfLayout : PdfPageEventHelper
    {
        string minDate = "", maxDate = "", totalCredit = "", totalDebit = "", company = "";
        double totalProfitLoss = 0, profitLossPercentage = 0, totalCredits = 0, totalDebits = 0;
        public ProfitLossReportCompanyCustomPdfLayout(string MinDate, string MaxDate, string TotalCredit, string TotalDebit,
            string company,
        ...
        public override void OnEndPage(iTextSharp.text.pdf.PdfWriter writer, iTextSharp.text.Document document)
        {
            ...
            Phrase p1Header = new Phrase("Profit & Loss Custom Report From " + minDate + " Till " + maxDate + " of " + company, baseFontNormal);
