...
{
    public class BalanceSheetCompanyWeeklyPdfLayout : PdfPageEventHelper
    {
        string minDate = "", maxDate = "", totalCredit = "", totalDebit = "", company = "", totalBalance = "";
        public BalanceSheetCompanyWeeklyPdfLayout(
            string MinDate, string MaxDate, string TotalCredit, string TotalDebit, string company, string totalBalance
        )
        {
        ...
        public override void OnEndPage(iTextSharp.text.pdf.PdfWriter writer, iTextSharp.text.Document document)
        {
            ...
            Phrase p1Header = new Phrase("Balance Sheet Weekly Report From " + minDate + " Till " + maxDate + " of " + company, baseFontNormal);
            ...
            if (!totalBalance.StartsWith("-"))
            {
                p4Header = new Phrase("Total Balance : " + totalBalance + " AED ", creditFont);
            }
            else
            {
                p4Header = new Phrase("Total Balance : " + totalBalance + " AED ", debitFont);
            }
