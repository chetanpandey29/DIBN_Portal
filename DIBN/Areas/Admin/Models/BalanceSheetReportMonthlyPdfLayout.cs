...
{
    public class BalanceSheetReportMonthlyPdfLayout : PdfPageEventHelper
    {
        string month = "", year = "", totalCredit = "", totalDebit = "", totalBalance = "";
        public BalanceSheetReportMonthlyPdfLayout(string month, string year, string totalCredit, string totalDebit, string totalBalance)
        {
            this.month = month;
            this.year = year;
        ...
        public override void OnEndPage(iTextSharp.text.pdf.PdfWriter writer, iTextSharp.text.Document document)
        {
            ...
            Phrase p1Header = new Phrase("Balance Sheet Monthly Report of " + month + " , " + year + "", baseFontNormal);
