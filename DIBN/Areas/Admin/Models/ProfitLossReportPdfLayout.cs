...
{
    public class ProfitLossReportCustomPdfLayout : PdfPageEventHelper
    {
        string minDate = "", maxDate = "",totalCredit="",totalDebit="";
        double totalProfitLoss = 0, profitLossPercentage = 0, totalCredits = 0, totalDebits = 0;
        public ProfitLossReportCustomPdfLayout(string MinDate, string MaxDate,string TotalCredit,string TotalDebit,
        ...
        public override void OnEndPage(iTextSharp.text.pdf.PdfWriter writer, iTextSharp.text.Document document)
        {
            ...
            Phrase p1Header = new Phrase("Profit & Loss Custom Report From " + minDate + " Till " + maxDate + "", baseFontNormal);
            ...
            //Add paging to footer  
            {
                ...
                content.EndText();
                len = bf.GetWidthPoint(text + currentPage, 8);
