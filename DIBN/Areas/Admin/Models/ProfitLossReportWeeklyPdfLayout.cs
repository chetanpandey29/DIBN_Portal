...
{
    public class ProfitLossReportWeeklyPdfLayout : PdfPageEventHelper
    {
        ...
        public ProfitLossReportWeeklyPdfLayout(string MinDate, string MaxDate, string TotalCredit, string TotalDebit,
        ...
        public override void OnEndPage(iTextSharp.text.pdf.PdfWriter writer, iTextSharp.text.Document document)
        {
            ...
            Phrase p1Header = new Phrase("Profit & Loss Weekly Report of " + minDate + " - " + maxDate + "", baseFontNormal);
