...
{
    public class BalanceSheetCompanyCustomPdfLayout : PdfPageEventHelper
    {
        string minDate = "", maxDate = "", totalCredit = "", totalDebit = "", company = "",totalBalance = "";
        public BalanceSheetCompanyCustomPdfLayout(
        ...
        public override void OnEndPage(iTextSharp.text.pdf.PdfWriter writer, iTextSharp.text.Document document)
        {
            ...
            Phrase p1Header = new Phrase("Balance Sheet Custom Report From " + minDate + " Till " + maxDate + " of " + company, baseFontNormal);
