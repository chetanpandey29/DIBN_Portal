...
{
    public class ProfitLossReportCompanyMonthlyPdfLayout : PdfPageEventHelper
    {
        string month = "", year = "", totalCredit = "", totalDebit = "",company="";
        double totalProfitLoss = 0, profitLossPercentage = 0, totalCredits = 0, totalDebits = 0;
        public ProfitLossReportCompanyMonthlyPdfLayout(string Month, string Year,string company, string TotalCredit, string TotalDebit,
        ...
        public override void OnEndPage(iTextSharp.text.pdf.PdfWriter writer, iTextSharp.text.Document document)
        {
            ...
            Phrase p1Header = new Phrase("Profit & Loss Monthly Report of " + month + " , " + year + " of " + company, baseFontNormal);
