...
{
    public class BalanceSheetReportCustomPdfLayout : PdfPageEventHelper
    {
        string minDate = "", maxDate = "", totalCredit = "", totalDebit = "",totalBalance="";
        public BalanceSheetReportCustomPdfLayout(string minDate,string maxDate,string totalCredit,string totalDebit,string totalBalance)
        {
        ...
        public override void OnEndPage(iTextSharp.text.pdf.PdfWriter writer, iTextSharp.text.Document document)
        {
            ...
            Phrase p1Header = new Phrase("Balance Sheet Custom Report From " + minDate + " Till " + maxDate + "", baseFontNormal);
