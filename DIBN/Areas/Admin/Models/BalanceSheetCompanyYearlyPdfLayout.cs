...
{
    public class BalanceSheetCompanyYearlyPdfLayout : PdfPageEventHelper
    {
        string year = "", totalCredit = "", totalDebit = "", company = "", totalBalance = "";
        public BalanceSheetCompanyYearlyPdfLayout(
            string year, string totalCredit, string totalDebit, string company, string totalBalance
        )
        {
            this.year = year;
        ...
        public override void OnEndPage(iTextSharp.text.pdf.PdfWriter writer, iTextSharp.text.Document document)
        {
            ...
            Phrase p1Header = new Phrase("Balance Sheet Yearly Report ( " + year + " ) of " + company, baseFontNormal);
