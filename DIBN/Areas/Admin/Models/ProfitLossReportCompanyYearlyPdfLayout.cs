...
{
    public class ProfitLossReportCompanyYearlyPdfLayout : PdfPageEventHelper
    {
        string year = "", totalCredit = "", totalDebit = "",company="";
        double totalProfitLoss = 0, profitLossPercentage = 0, totalCredits = 0, totalDebits = 0;

        public ProfitLossReportCompanyYearlyPdfLayout(string Year,string company, string TotalCredit, string TotalDebit,
        ...
        public override void OnEndPage(iTextSharp.text.pdf.PdfWriter writer, iTextSharp.text.Document document)
        {
            ...
            Phrase p1Header = new Phrase("Profit & Loss Yearly Report of " + year + " - " + company, baseFontNormal);
