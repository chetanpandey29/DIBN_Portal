...
{
    public class ProfitLossReportYearlyPdfLayout : PdfPageEventHelper
    {
        string year = "", totalCredit = "", totalDebit = "";
        double totalProfitLoss = 0, profitLossPercentage = 0, totalCredits = 0, totalDebits = 0;

        public ProfitLossReportYearlyPdfLayout(string Year, string TotalCredit, string TotalDebit,
        ...
        public override void OnEndPage(iTextSharp.text.pdf.PdfWriter writer, iTextSharp.text.Document document)
        {
            ...
            Phrase p1Header = new Phrase("Profit & Loss Yearly Report of " + year + "", baseFontNormal);
