...
{
    public class ProfitLossReportCompanyWeeklyPdfLayout : PdfPageEventHelper
    {
        ...
        public ProfitLossReportCompanyWeeklyPdfLayout(string MinDate, string MaxDate, string TotalCredit, string TotalDebit,
            string company,
        ...
        public override void OnEndPage(iTextSharp.text.pdf.PdfWriter writer, iTextSharp.text.Document document)
        {
            ...
            Phrase p1Header = new Phrase("Profit & Loss Weekly Report of " + minDate + " - " + maxDate + " of " +company, baseFontNormal);
