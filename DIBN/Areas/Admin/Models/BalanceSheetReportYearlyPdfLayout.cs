...
{
    public class BalanceSheetReportYearlyPdfLayout : PdfPageEventHelper
    {
        string year = "", totalCredit = "", totalDebit = "", totalBalance = "";
        public BalanceSheetReportYearlyPdfLayout(string year, string totalCredit, string totalDebit, string totalBalance)
        {
            this.year = year;
        ...
        public override void OnEndPage(iTextSharp.text.pdf.PdfWriter writer, iTextSharp.text.Document document)
        {
            ...
            Phrase p1Header = new Phrase("Balance Sheet Yearly Report of " + year + "", baseFontNormal);
