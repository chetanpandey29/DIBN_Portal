...
{
    public class BalanceSheetCompanyMonthlyPdfLayout : PdfPageEventHelper
    {
        string month = "", year = "", totalCredit = "", totalDebit = "", company = "", totalBalance = "";
        public BalanceSheetCompanyMonthlyPdfLayout(
            string month , string year , string totalCredit , string totalDebit , string company , string totalBalance
        )
        {
            this.month = month;
            this.year = year;
        ...
        public override void OnEndPage(iTextSharp.text.pdf.PdfWriter writer, iTextSharp.text.Document document)
        {
            ...
            Phrase p1Header = new Phrase("Balance Sheet Monthly Report ( " + month + " , " + year + " ) of " + company, baseFontNormal);
