...
namespace DIBN.Areas.Admin.Data
{
    public class EncryptionService
    {
        ...
        //{
        //    return HashHelpers.CreateHash(Encoding.UTF8.GetBytes(string.Concat(password, saltkey)), passwordFormat);
        //}
        ...
        public virtual string EncryptText(string plainText, string encryptionPrivateKey = "")
        {
            ...
            if (string.IsNullOrEmpty(encryptionPrivateKey))
                encryptionPrivateKey = "5754178809261006"; //_securitySettings.EncryptionKey;
        ...
        public virtual string DecryptText(string cipherText, string encryptionPrivateKey = "")
        {
            ...
            if (string.IsNullOrEmpty(encryptionPrivateKey))
                encryptionPrivateKey = "5754178809261006";
